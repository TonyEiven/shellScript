...
class zabbixtools:
    def __init__(self):
        self.url = "http://10.200.40.24/zabbix/api_jsonrpc.php"
    ...
    def host_get(self,hostip):
        ...
        if (res != 0) and (len(res) != 0):
            ...
            host = res[0]
            if host['status'] == '1':
                print "\t","\033[1;31;40m%s\033[0m" % "Host_IP:","\033[1;31;40m%s\033[0m" %host['host'].ljust(15),'\t',"\033[1;31;40m%s\033[0m" % "Host_Name:","\033[1;31;40m%s\033[0m"% host['name'].encode('GBK'),'\t',"\033[1;31;40m%s\033[0m" % u'......'.encode('GBK')
                return host['hostid']
            elif host['status'] == '0':
                print "\t","\033[1;32;40m%s\033[0m" % "Host_IP:","\033[1;32;40m%s\033[0m" %host['host'].ljust(15),'\t',"\033[1;32;40m%s\033[0m" % "Host_Name:","\033[1;32;40m%s\033[0m"% host['name'].encode('GBK'),'\t',"\033[1;32;40m%s\033[0m" % u'.....'.encode('GBK')
                return host['hostid']
            print
        else:
